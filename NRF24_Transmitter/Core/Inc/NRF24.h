...
#define CS_GPIO_PORT GPIOA  //группа портов А
#define CS_PIN GPIO_PIN_4   //пин PA4, отвечающий за сигнал CSN для NRF24
#define CS_ON HAL_GPIO_WritePin(CS_GPIO_PORT, CS_PIN, GPIO_PIN_RESET) 
							//HAL_GPIO_WritePin устанавливает состояние вывода
